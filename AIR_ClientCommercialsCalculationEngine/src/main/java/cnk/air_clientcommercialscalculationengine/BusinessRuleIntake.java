...
public class BusinessRuleIntake implements java.io.Serializable
{
   ...
   private java.util.List<cnk.air_clientcommercialscalculationengine.FlightDetails> flightDetails;
   ...
   private java.util.List<cnk.air_clientcommercialscalculationengine.CommercialHead> commercialHead;
   ...
   public java.util.List<cnk.air_clientcommercialscalculationengine.CommercialHead> getCommercialHead()
   {
      return this.commercialHead;
   }

   public void setCommercialHead(
         java.util.List<cnk.air_clientcommercialscalculationengine.CommercialHead> commercialHead)
   {
   ...
   public cnk.air_clientcommercialscalculationengine.CommonElements getCommonElements()
   {
      return this.commonElements;
   }

   public void setCommonElements(
         cnk.air_clientcommercialscalculationengine.CommonElements commonElements)
   {
      this.commonElements = commonElements;
   }

   public cnk.air_clientcommercialscalculationengine.AdvancedDefinition getAdvancedDefinition()
   {
      return this.advancedDefinition;
   }

   public void setAdvancedDefinition(
         cnk.air_clientcommercialscalculationengine.AdvancedDefinition advancedDefinition)
   {
   ...
   public java.util.List<cnk.air_clientcommercialscalculationengine.FlightDetails> getFlightDetails()
   {
      return this.flightDetails;
   }

   public void setFlightDetails(
         java.util.List<cnk.air_clientcommercialscalculationengine.FlightDetails> flightDetails)
   {
